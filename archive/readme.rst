DeeperMind pokerbot for PokerStars, PartyPoker, GGPoker and custom-mapped rooms
==========================================================

This pokerbot plays automatically on PokerStars, PartyPoker and GGPoker with bundled table profiles. Other rooms such as Winamax, WPT Global, iPoker-style tables and CoinPoker can be supported through the built-in table mapper.
