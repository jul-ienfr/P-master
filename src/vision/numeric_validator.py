...
class NumericValidator:
    def validate(
        self, field_name: str, previous_value: float, candidate_value: float | None
    ...
    def _coerce_values(
        self, previous_value: float, candidate_value: float | None
    ...
    def validate_pot(
        ...
        if candidate_value is None:
            return NumericValidationResult(
                accepted_value=None, valid=False, reject_reason="missing_candidate"
            )
        if coerced is None:
            return NumericValidationResult(
                accepted_value=None, valid=False, reject_reason="invalid_numeric_value"
            )
        ...
        if candidate == 0.0 and previous > 0.0:
            return NumericValidationResult(
                accepted_value=previous, valid=False, reject_reason="suspicious_zero_regression"
            )
    ...
    def validate_stack(
        ...
        if candidate > 200000.0:
            return NumericValidationResult(
                accepted_value=None, valid=False, reject_reason="stack_too_large"
            )
        return NumericValidationResult(accepted_value=candidate, valid=True)
    ...
    def validate_bet(
        ...
        if candidate > 200000.0:
            return NumericValidationResult(
                accepted_value=None, valid=False, reject_reason="bet_too_large"
            )
        return NumericValidationResult(accepted_value=candidate, valid=True)
    ...
    def validate_amount(
        ...
        if candidate > 200000.0:
            return NumericValidationResult(
                accepted_value=None, valid=False, reject_reason="amount_too_large"
            )
        return NumericValidationResult(accepted_value=candidate, valid=True)
