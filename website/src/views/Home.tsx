    ...
    return (
        <>
            <div className="description">
                ...
                This pokerbot ships with bundled table profiles for PokerStars, PartyPoker and GGPoker, and its built-in table mapper can be used to add rooms such as Winamax, WPT Global, iPoker-style tables and CoinPoker. It works with image recognition, montecarlo simulation and a basic genetic algorithm. The mouse is moved automatically and the bot can potentially play for hours based on a large number of parameters.
            </div>
